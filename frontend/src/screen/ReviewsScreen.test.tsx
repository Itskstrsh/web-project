...
jest.mock('../data/reviewsData', () => ({
  reviewsData: [
    { id: 1, name: 'User 1', text: 'Review 1', rating: 5, date: '2024-01-01', image: null },
    { id: 2, name: 'User 2', text: 'Review 2', rating: 4, date: '2024-01-02', image: null },
    { id: 3, name: 'User 3', text: 'Review 3', rating: 5, date: '2024-01-03', image: null },
  ],
}));
